...
var chartw = function(ctract,nhood)
{
   if(document.getElementById("ctmain").checked){
    ...
    d3.csv(""+link, function(threedata)
    {
          data = threedata.map(function(d)
            {
              ...
              if(document.getElementById("ctmain").checked){
                ...
                medincome = parseInt(d['income per capita'+'_n'])
        ...
        findct(""+ctract,"hholds",'svgw2','barchartw2');
        findct(""+ctract,"calls",'svgw3','barchartw3');
            
        datanew= threedata.map(function(d){
            v = (d['ID'])
            v1 = parseInt(d['Population under 18']+'_n');
            v2 = parseInt(d['population between 18 and 34']+'_n');
            v3 = parseInt(d['population between 35 to 64']+'_n');
            v4 = parseInt(d['population 65 and over']+'_n');
            v1r = parseInt(d['owner  occupied units']+'_n');
            v2r = parseInt(d['renter occupied units']+'_n');
